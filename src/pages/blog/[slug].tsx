  ...
  return (
    <>
      <PageSeo
        ...
        image={post.cover}
        isArticle
        shouldNoIndex={post.isDraft}
        schema={
          post.isDraft || !post.author
            ? []
            : [
                {
                  "@type": "BlogPosting",
      ...
      <Container className="story-page">
        ...
        <div className="article-meta">
          {post.isDraft ? <span>{t("draftPreview")}</span> : null}
...
export function getStaticPaths() {
  return { paths: entityPaths("blog", process.env.NODE_ENV === "development"), fallback: false };
}
export async function getStaticProps(context: GetStaticPropsContext) {
  ...
  return {
    props: {
      ...
      post: await postDetail(id, locale, process.env.NODE_ENV === "development"),
    },
  };
}
